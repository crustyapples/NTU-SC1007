...
int nQueens(int** board, int BSize, int col)
{
     ...
     // place a queen in the top left 
     // place a queen in the second column and move until place is valid
     // place in third and move until valid
     // if no place at ith queen, backtrack to move the i-1th queen
